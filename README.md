...
A comprehensive web-based management tool for Docker MCP Gateway that provides browser-based administration capabilities.

[日本語版のREADME](./README_ja.md) | **English**
...
- All containers run with non-root privileges
- Comprehensive security headers
- Encrypted secret management
- Input validation and sanitization
- Rate limiting and DoS protection

If you discover a security issue, please report it privately rather than through public issues.
...
- [Tailwind CSS](https://tailwindcss.com/) creators
- Open source community

---

**Note**: This project is under active development. Please test thoroughly before production use.
